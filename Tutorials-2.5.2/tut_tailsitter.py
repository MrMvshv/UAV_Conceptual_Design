...
def plot_mission(results):
    ...
    print('Plotting Mission Results')
    #print(results)
...
def save_mission_plots(results):
    """
    Saves all mission plots to a timestamped subfolder without displaying them
    """
    # Create timestamped subfolder
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    output_dir = f"mission_plots_{timestamp}"
    os.makedirs(output_dir, exist_ok=True)
    
    # List of all plot functions from plot_mission()
    plot_functions = [
        ("flight_conditions.png", plot_flight_conditions),
        ("aero_coefficients.png", plot_aerodynamic_coefficients),
        ("aircraft_velocities.png", plot_aircraft_velocities),
        ("battery_conditions.png", plot_battery_pack_conditions),
        ("propeller_conditions.png", plot_propeller_conditions),
        ("motor_prop_efficiencies.png", plot_eMotor_Prop_efficiencies),
        ("disc_power_loading.png", plot_disc_power_loading)
    ]
    ...
    return output_dir  # Return path for further use

if __name__ == '__main__':
    print('Running the Tailsitter Tutorial')
    main()
    print('Done!')
    plt.show()